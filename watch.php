...
{
    $id = $_GET['vid'];
    $query ="select vname from video where vid=$id ";
    ...
    <div class="video-container" id="video-container">
      <div class="playback-animation" id="playback-animation">
        <svg class="playback-icons">
         ...
         <span style="text-align: center; margin-bottom: 25px;  color: blue; font-size: 25px;"><?php   echo "you are watching  ".$name."<br />"; ?></span>
      <video controls class="video" id="video" preload="metadata" poster="poster.jpg">         
          <source src="video_location/<?php echo $name; ?>" type="video/webm"></source>
      </video>
